...
namespace ExploringCSharp
{
    public class DoingMath
    {
        public int ReturnTheLargerNumber(int number1, int number2)
        {
            ...
            // I managed to get it to type "Math" by typing out the full word and hitting Enter without choosing one of the suggestions.
        }
        ...
        public int MultiplyByTheNextLargerPowerOfTen(int number)
        {
            ...
            return (int) (number*(Math.Log10(number)+1));
        }
