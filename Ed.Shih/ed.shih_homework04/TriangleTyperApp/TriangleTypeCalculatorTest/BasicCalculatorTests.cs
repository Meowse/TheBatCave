...
namespace TriangleTypeCalculatorTest
{
    ...
    public class BasicCalculatorTests
    {
        ...
        {
            Assert.That(_calculator.GetTriangleType("0", "0", "0"), Is.EqualTo("Sides must be greater than 0 and less than 2,000,000,001"));
        }
        [Test]
        public void TestIntRange2()
        {
            Assert.That(_calculator.GetTriangleType("-4", "4", "20"), Is.EqualTo("Sides must be greater than 0 and less than 2,000,000,001"));
        }
        [Test]
        public void TestIntRange3()
        {
            Assert.That(_calculator.GetTriangleType("2000000001", "2000000001", "2000000001"), Is.EqualTo("Sides must be greater than 0 and less than 2,000,000,001"));
        }
        [Test]
        public void TestIntRange4()
        {
            Assert.That(_calculator.GetTriangleType("2000000001", "0", "2000000001"), Is.EqualTo("Sides must be greater than 0 and less than 2,000,000,001"));
        }
        [Test]
        ...
        {
            Assert.That(_calculator.GetTriangleType("2000000000", "2000000000", "1"), Is.EqualTo("Isoscoles"));
        }
        [Test]
        ...
        {
            Assert.That(_calculator.GetTriangleType("2000000000", "1999999999", "2"), Is.EqualTo("Scalene"));
        }
    }
}
