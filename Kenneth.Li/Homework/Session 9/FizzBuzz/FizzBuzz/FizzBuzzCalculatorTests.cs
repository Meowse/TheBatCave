...
{
    [TestFixture]
    internal class FizzBuzzCalculatorTests
    {
        ...
        [Test]
        public void FizzBuzzBim235ReturnsFizzBuzzBimForMultiplesOf235()
        {
            var fizzBuzzBim235 = new FizzBuzzCalculator(2, 3, 5);
            Assert.That(fizzBuzzBim235.Calculate(2*3*5), Is.EqualTo("FizzBuzzBim"));
            Assert.That(fizzBuzzBim235.Calculate(2 * 2 * 3 * 5), Is.EqualTo("FizzBuzzBim"));
            Assert.That(fizzBuzzBim235.Calculate(3 * 2 * 3 * 5), Is.EqualTo("FizzBuzzBim"));
        }
    }
}
