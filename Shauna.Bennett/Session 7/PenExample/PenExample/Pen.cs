    ...
    public class Pen
    {
        ...
        public bool IsCapped
        {
            ...
            set
            {
                if (_isCapped && value)
                {
                    MessagBox.show("pen is already capped.");
                    return;
                }
                if (!_isCapped && value)
                {
                    MessagBox.show("pen is already uncapped");
                    return;
                }
                _isCapped = value;
            }
        ...
        public string Description
        {
            get
            {
                ...
                {
                    return_description + " (uncapped)";
                }
            }
            protected set { _descrption = value; }
        }
