...
namespace CountWords
{
    ...
    public class WordCounter
    {
        ...
        {
            WordCountRecord myCount = new WordCountRecord();
            myCount.Words = new List<string>();
            myCount.Counts = new List<int>();

            foreach (var word in _words)
            {
                if (!myCount.Words.Contains(word))
                {
                    myCount.Words.Add(word);
                    myCount.Counts.Add(WordCount(word));
                }
            }
